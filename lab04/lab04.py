...
# Ustalenie transformacji
transform = transforms.Compose([transforms.ToTensor(), transforms.Normalize((0.5,), (0.5,))])

# Pobranie zbioru FashionMNIST
...
for model, model_name in zip(models, model_names):
    ...
    # Przywracanie modelu i ustawienie funkcji straty oraz optymalizatora
    ...
    for epoch in range(num_epochs):
        ...
        for images, labels in train_loader:
            ...
            outputs = model(images)  # Przewidywanie
    ...
    # Testowanie modelu i generowanie wyników
    ...
    with torch.no_grad():  # Brak potrzeby obliczania gradientów
        for images, labels in test_loader:
            ...
            # Zapisywanie niewłaściwie sklasyfikowanych obrazów
    ...
    # Pokazywanie jednego źle zaklasyfikowanego obrazka
    incorrect_image, predicted_class, true_class = incorrect_images[0]
    incorrect_image = incorrect_image.squeeze().cpu().numpy()  # Usuwamy dodatkowy wymiar
